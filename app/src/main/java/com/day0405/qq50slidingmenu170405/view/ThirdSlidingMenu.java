...
public class ThirdSlidingMenu extends HorizontalScrollView {
     ...
     * @param attrs
     */
    public ThirdSlidingMenu(Context context, AttributeSet attrs) {
//        super(context, attrs);
        /**
     ...
     * 这里我们去让它调用两个参数的构造方法
     */
    public ThirdSlidingMenu(Context context) {
//        super(context);
        this(context, null);
    }
    ...
    public ThirdSlidingMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.ThirdSlidingMenu, defStyleAttr, 0);
        ...
        for(int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.ThirdSlidingMenu_rightPadding3:
                    //如果是的话，给右边距赋值
